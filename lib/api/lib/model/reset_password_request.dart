...
class ResetPasswordRequest {
  ...
  bool operator ==(Object other) => identical(this, other) || other is ResetPasswordRequest &&
    other.token == token &&
    other.nouveauMotDePasse == nouveauMotDePasse;

  @override
  int get hashCode =>
    // ignore: unnecessary_parenthesis
    (token.hashCode) +
    (nouveauMotDePasse.hashCode);

  @override
  String toString() => 'ResetPasswordRequest[token=$token, nouveauMotDePasse=$nouveauMotDePasse]';

  Map<String, dynamic> toJson() {
    final json = <String, dynamic>{};
      json[r'token'] = this.token;
      json[r'nouveauMotDePasse'] = this.nouveauMotDePasse;
    return json;
  }
  ...
  static ResetPasswordRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ResetPasswordRequest(
        ...
        nouveauMotDePasse: mapValueOfType<String>(json, r'nouveauMotDePasse')!,
      );
    }
    return null;
  }
