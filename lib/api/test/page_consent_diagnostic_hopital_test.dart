...
// tests for PageConsentDiagnosticHopital
void main() {
  // final instance = PageConsentDiagnosticHopital();

  group('test PageConsentDiagnosticHopital', () {
    // int totalPages
    ...
    // List<ConsentDiagnosticHopital> content (default value: const [])
